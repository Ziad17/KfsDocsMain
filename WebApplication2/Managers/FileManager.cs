...
namespace WebApplication2.Managers
{
    public class FileManager
    {
        ...
        public FileManager()
        {
             blobService = new BlobServiceClient(CONNECTION_STRINGS);

        }


        public bool uploadFile(string fileName, Stream file)
        {

            containerClient = blobService.GetBlobContainerClient(MAIN_CONTAINER);
        ...
        public bool uploadImage(string fileName,Stream file)
        {
        ...
        public byte[] getFileStream(string FileUrl)
        {
            if (FileUrl == null)
            { return null; }
            containerClient = blobService.GetBlobContainerClient(MAIN_CONTAINER);
