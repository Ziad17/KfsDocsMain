...
namespace WebApplication2.Controllers
{
    public class InstitutionsController : BaseController
    {
        ...
        private bool isPartOfInstitution(int EmployeeRoleID, int InstitutionID)
        {
        ...
        public ActionResult InstitutionProfile(int? id)
        {
            ...
            if (hasInstitutionPermission(role.ID, InstitutionPermissions.VIEW_INSTITUTION))
            {
                ...
                viewModel.Institution.ImageURL = "";
                      viewModel.EmployeeRoles = db.EmployeeRoles.Where(x => x.InstitutionID == institution.ID).ToList<EmployeeRole>();
